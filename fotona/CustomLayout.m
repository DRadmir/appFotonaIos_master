...
static NSString * const GEMainMenuCellKind = @"GEMainMenuCell";
...
- (void)prepareLayout
{
    ...
    newLayoutInfo[GEMainMenuCellKind] = cellLayoutInfo;
...
{
    return self.layoutInfo[GEMainMenuCellKind][indexPath];
}
